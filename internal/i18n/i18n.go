...
var translations = map[string]map[string]string{
	LangEN: {
		...
		"seg_modal_dhcp_help":           "Specify DHCP IP ranges (e.g. 100-200, 192.168.0.100-200, or full IPs). Multiple ranges separated by commas are supported. Unapproved dynamic DHCP hosts will be marked with a green badge (🟢) without raising security alerts.",
	...
	LangJA: {
		...
		"seg_modal_dhcp_help":           "動的に払い出されるDHCP端末帯域（例: 100-200、192.168.0.100-200、フルIP形式）を指定します。複数範囲はカンマ区切りで指定可能。未承認時の赤色警戒表示を抑え、緑色バッジ (🟢) で表示します。",
