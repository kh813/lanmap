...
var translations = map[string]map[string]string{
	LangEN: {
		...
		"col_ip_assignment":  "IP Assignment",
		"col_approval":       "Approval",
		"col_status":         "Status",
		"col_latency":        "Latency",
		"col_is_monitored":   "Monitored",
		...
		"filter_assignment_all":      "All",
		"filter_assignment_dhcp":     "🔵 DHCP",
		"filter_assignment_static":   "🟢 Static IP",
		"filter_assignment_unknown":  "⚪ Unknown",
		"filter_monitored_all":       "All",
		"filter_monitored_yes":       "☑️ Monitored",
		"filter_monitored_no":        "◻️ Not Monitored",
		...
		"action_monitor":            "👁️ Mark as Monitored Target",
		"action_unmonitor":          "👁️ Remove from Monitored",
		...
		"settings_webhook_label":          "🔔 Webhook Integration (Google Chat, Slack, Teams, Discord)",
		"settings_notif_events_title":      "🔔 Notification Target Events (Alert Conditions)",
		"settings_notif_events_help":       "Choose which network events trigger webhook notifications. You can toggle monitored host down alerts, unapproved devices, and security alerts.",
		"settings_notif_monitored_down":    "Monitored Host Down (Outage Alert)",
		"settings_notif_monitored_down_desc": "Send high-priority alerts immediately when a designated monitored device goes offline (Default: ON).",
		"settings_notif_monitored_up":      "Monitored Host Recovery (Up Alert)",
		"settings_notif_monitored_up_desc":   "Send notification when an offline monitored device recovers and comes back online (Default: ON).",
		"settings_notif_unapproved_static": "Unapproved Static / Fixed IP Devices",
		"settings_notif_unapproved_static_desc": "Send alerts when a new unapproved device with a static or fixed IP is detected on the LAN (Default: OFF).",
		"settings_notif_unapproved_dhcp":   "Unapproved DHCP Devices",
		"settings_notif_unapproved_dhcp_desc": "Send alerts when a new unapproved device assigned via DHCP is detected (Default: OFF - may generate frequent alerts for visitors).",
		"settings_notif_security":          "Critical Security Alerts (Broadcast Storm / Rogue RA)",
		"settings_notif_security_desc":      "Send emergency alerts for excessive broadcast traffic, network loops, or unauthorized router advertisements (Default: ON).",
	...
	LangJA: {
		...
		"col_connection":      "接続形態",
		"col_ip_assignment":  "IP割当",
		"col_approval":       "承認",
		"col_status":         "状態",
		"col_latency":        "応答速度",
		"col_is_monitored":   "監視対象",
		"col_static_ip":      "固定IP",
		"col_actions":        "操作",
		...
		"filter_conn_wifi":           "📶 Wi-Fi",
		"filter_assignment_all":      "すべて",
		"filter_assignment_dhcp":     "🔵 DHCP",
		"filter_assignment_static":   "🟢 固定IP",
		"filter_assignment_unknown":  "⚪ 不明",
		"filter_monitored_all":       "すべて",
		"filter_monitored_yes":       "☑️ 監視対象",
		"filter_monitored_no":        "◻️ 非監視",
		...
		"action_monitor":            "👁️ 監視対象に指定 (障害通知)",
		"action_unmonitor":          "👁️ 監視対象から除外",
		...
		"settings_webhook_label":          "🔔 外部通知連携 (Google Chat, Slack, Teams, Discord)",
		"settings_notif_events_title":      "🔔 通知対象イベントの選択 (アラート発生条件)",
		"settings_notif_events_help":       "どのネットワークイベントで Webhook 通知を送信するかを選択できます。監視対象ホストのDown時や未確認端末の検知を任意に切り替えられます。",
		"settings_notif_monitored_down":    "監視対象ホストの障害検知 (Down アラート)",
		"settings_notif_monitored_down_desc": "監視対象フラグが有効な重要機器がオフライン（応答途絶）になった際に即座に通知します（デフォルト: 有効）。",
		"settings_notif_monitored_up":      "監視対象ホストの復旧検知 (Up 通知)",
		"settings_notif_monitored_up_desc":   "ダウンしていた監視対象機器がオンラインに復帰した際に通知します（デフォルト: 有効）。",
		"settings_notif_unapproved_static": "未承認・未確認端末の検知 (固定IP / 不明IP)",
		"settings_notif_unapproved_static_desc": "管理リストに未登録の固定IP端末が新たにLAN内で検知された際に通知します（デフォルト: 無効）。",
		"settings_notif_unapproved_dhcp":   "未承認・未確認端末の検知 (DHCP端末)",
		"settings_notif_unapproved_dhcp_desc": "DHCPで自動割り当てされた未登録端末（出張者・来客等）が検知された際にも通知します（デフォルト: 無効 - 通知が多くなる場合があります）。",
		"settings_notif_security":          "重大セキュリティアラート (ブロードキャスト過多 / 不正RA)",
		"settings_notif_security_desc":      "機器の暴走、ループ配線によるストーム、不正ルーター広告(Rogue RA)を検知した際に通知します（デフォルト: 有効）。",
