...
var translations = map[string]map[string]string{
	LangEN: {
		...
		"settings_scan_mode_safe_desc":"Only uses ICMP Ping, ARP, and mDNS/DNS. Zero port scanning. Prevents false positive alerts from security software or UTM firewalls.",
	...
	LangJA: {
		...
		"settings_scan_mode_safe_desc":"Ping、ARPテーブル、リバースDNS/mDNSのみで静かに監視します。ポートスキャンを行わないため、セキュリティソフトやUTMから攻撃と誤認識されません。",
