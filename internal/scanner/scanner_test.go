...
func TestOUILookup(t *testing.T) {
	tests := []struct {
		...
		{"02:11:32:11:22:33", "Synology (仮想マシン VMM)"},
		{"52:54:00:12:34:56", "QEMU / KVM (仮想マシン)"},
		{"BC:24:11:AA:BB:CC", "Proxmox VE (仮想マシン)"},
		{"00:50:56:12:34:56", "VMware ESXi / vSphere (仮想マシン)"},
		{"00:0C:29:12:34:56", "VMware Workstation / Fusion (仮想マシン)"},
		{"00:15:5D:12:34:56", "Microsoft Hyper-V / WSL2 (仮想マシン)"},
		{"08:00:27:12:34:56", "Oracle VirtualBox (仮想マシン)"},
		{"00:16:3E:12:34:56", "Xen / Citrix / LXD (仮想マシン)"},
		{"00:1C:42:12:34:56", "Parallels Desktop (仮想マシン)"},
		{"50:6B:8D:12:34:56", "Nutanix AHV (仮想マシン)"},
		{"02:42:AC:11:00:02", "Docker Container (仮想NIC)"},
		{"B8:27:EB:00:11:22", "Raspberry Pi"},
		{"bc:a5:11:e0:90:cf", "Netgear"},
		{"24:0A:C4:00:11:22", "Espressif (ESP32/ESP8266)"},
		{"10:5A:17:00:11:22", "Tuya (Smart Life/IoT)"},
		{"B0:E9:FE:00:11:22", "SwitchBot (Woan Tech)"},
		{"00:17:88:00:11:22", "Philips Hue (Signify)"},
		{"00:80:4F:00:11:22", "Daikin"},
		{"00:00:00:00:00:00", ""},
